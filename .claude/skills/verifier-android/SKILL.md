...
adb shell pidof com.fastvibes.huismus  # app running? (Metro must be up too)
...
```bash
adb shell am force-stop com.fastvibes.huismus
adb shell am start -W -a android.intent.action.VIEW \
  -d "huismus://profile" com.fastvibes.huismus
```
...
- **Deep links** jump straight to a route: `adb shell am start -a android.intent.action.VIEW
  -d "huismus://settings/appearance" com.fastvibes.huismus`. But to test a
